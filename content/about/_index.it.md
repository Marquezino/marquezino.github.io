...
Ho conseguito il dottorato in Computational Modeling presso il National Laboratory for Scientific Computing (LNCC, Brasile). La mia tesi di dottorato ha ricevuto il CAPES Theses Award (2011), uno dei più prestigiosi riconoscimenti accademici in Brasile.

Tra il 2024 e il 2025, ho svolto attività di ricerca post-dottorale presso il Centre for Quantum Computer Science della University of Latvia.

Sono coautore del libro A Primer on Quantum Computing (Springer) e membro dell’Editorial Board della rivista Theoretical Computer Science.

## Nota personale

Sono italo-brasiliano, nato e cresciuto in Brasile. Per ragioni personali e culturali, questo sito include anche una versione in italiano, una lingua che continuo ad apprendere con grande interesse.
 
Sono sposato e padre di due figli.

Mi piace giocare a scacchi, più per il piacere del gioco che per l’abilità. Sto attualmente imparando a suonare il violino, una sfida che si è rivelata più complessa di quanto sembrasse inizialmente, soprattutto per aver iniziato un po’ tardi.
